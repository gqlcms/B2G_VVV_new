...
float Process_1Lepton_Fatjet_SoftdropMass_NoJEC(Int_t FatJetindex ){
    Int_t FatJet_subJetIdx1 = nt.FatJet_subJetIdx1()[FatJetindex];
    Int_t FatJet_subJetIdx2 = nt.FatJet_subJetIdx2()[FatJetindex];
...
void Process_1Lepton_leptonicW(){
    ...
    if ( ana.tx.getBranchLazy<vector<int>>("Common_lep_idxs").size() == 1 ){
        ...
        {
            int ilep_idx = ana.tx.getBranchLazy<vector<int>>("Common_lep_idxs")[0];
            // these are relative ISO, already devide pt
            ana.tx.setBranch<float>("trackIso", nt.Muon_tkRelIso()[ilep_idx]);
            ana.tx.setBranch<float>("muisolation", nt.Muon_pfRelIso04_all()[ilep_idx]);
        }
    }
...
void Proces_1Lepton_NanoAODBranch(){
    ...
    // Genpart
    for (unsigned int inum = 0; inum < (nt.GenPart_pt()).size(); ++inum){
        ana.tx.pushbackToBranch<float>("Lepton1_GenPart_eta", nt.GenPart_eta()[inum]);
        ana.tx.pushbackToBranch<float>("Lepton1_GenPart_mass", nt.GenPart_mass()[inum]);
        ana.tx.pushbackToBranch<float>("Lepton1_GenPart_phi", nt.GenPart_phi()[inum]);
        ana.tx.pushbackToBranch<float>("Lepton1_GenPart_pt", nt.GenPart_pt()[inum]);
        ana.tx.pushbackToBranch<int>("Lepton1_GenPart_genPartIdxMother", nt.GenPart_genPartIdxMother()[inum]);
        ana.tx.pushbackToBranch<int>("Lepton1_GenPart_pdgId", nt.GenPart_pdgId()[inum]);
        ana.tx.pushbackToBranch<int>("Lepton1_GenPart_status", nt.GenPart_status()[inum]);
        ana.tx.pushbackToBranch<int>("Lepton1_GenPart_statusFlags", nt.GenPart_statusFlags()[inum]);
    }

}

void Proces_1Lepton_NanoAODBranch_NoPrefix(){
    // do not need to use loop here, can dirrectly set vector branch
    // FatJet
    for (unsigned int i = 0; i < (nt.FatJet_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("FatJet_area", nt.FatJet_area()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagCMVA", nt.FatJet_btagCMVA()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagCSVV2", nt.FatJet_btagCSVV2()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDBvL", nt.FatJet_btagDDBvL()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDBvL_noMD", nt.FatJet_btagDDBvL_noMD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDCvB", nt.FatJet_btagDDCvB()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDCvB_noMD", nt.FatJet_btagDDCvB_noMD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDCvL", nt.FatJet_btagDDCvL()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDDCvL_noMD", nt.FatJet_btagDDCvL_noMD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagDeepB", nt.FatJet_btagDeepB()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_btagHbb", nt.FatJet_btagHbb()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_H4qvsQCD", nt.FatJet_deepTagMD_H4qvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_HbbvsQCD", nt.FatJet_deepTagMD_HbbvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_TvsQCD", nt.FatJet_deepTagMD_TvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_WvsQCD", nt.FatJet_deepTagMD_WvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_ZHbbvsQCD", nt.FatJet_deepTagMD_ZHbbvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_ZHccvsQCD", nt.FatJet_deepTagMD_ZHccvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_ZbbvsQCD", nt.FatJet_deepTagMD_ZbbvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_ZvsQCD", nt.FatJet_deepTagMD_ZvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_bbvsLight", nt.FatJet_deepTagMD_bbvsLight()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTagMD_ccvsLight", nt.FatJet_deepTagMD_ccvsLight()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_H", nt.FatJet_deepTag_H()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_QCD", nt.FatJet_deepTag_QCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_QCDothers", nt.FatJet_deepTag_QCDothers()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_TvsQCD", nt.FatJet_deepTag_TvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_WvsQCD", nt.FatJet_deepTag_WvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_deepTag_ZvsQCD", nt.FatJet_deepTag_ZvsQCD()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_eta", nt.FatJet_eta()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_mass", nt.FatJet_mass()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_msoftdrop", nt.FatJet_msoftdrop()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_n2b1", nt.FatJet_n2b1()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_n3b1", nt.FatJet_n3b1()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_phi", nt.FatJet_phi()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_pt", nt.FatJet_pt()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_rawFactor", nt.FatJet_rawFactor()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_tau1", nt.FatJet_tau1()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_tau2", nt.FatJet_tau2()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_tau3", nt.FatJet_tau3()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_tau4", nt.FatJet_tau4()[i]);
        ana.tx.pushbackToBranch<float>("FatJet_lsf3", nt.FatJet_lsf3()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_jetId", nt.FatJet_jetId()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_subJetIdx1", nt.FatJet_subJetIdx1()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_subJetIdx2", nt.FatJet_subJetIdx2()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_electronIdx3SJ", nt.FatJet_electronIdx3SJ()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_muonIdx3SJ", nt.FatJet_muonIdx3SJ()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_genJetAK8Idx", nt.FatJet_genJetAK8Idx()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_hadronFlavour", nt.FatJet_hadronFlavour()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_nBHadrons", nt.FatJet_nBHadrons()[i]);
        ana.tx.pushbackToBranch<int>("FatJet_nCHadrons", nt.FatJet_nCHadrons()[i]);
    }
    ana.tx.setBranch<int>("nFatJet", nt.nFatJet());
    ana.tx.setBranch<int>("nGenJet", nt.nGenJet());
    ana.tx.setBranch<int>("nGenJetAK8", nt.nGenJetAK8());
    ana.tx.setBranch<int>("nJet", nt.nJet());
    ana.tx.setBranch<int>("nSubGenJetAK8", nt.nSubGenJetAK8());
    ana.tx.setBranch<int>("nSubJet", nt.nSubJet());
       

    // Jet
    for (unsigned int i = 0; i < (nt.Jet_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("Jet_area", nt.Jet_area()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagCMVA", nt.Jet_btagCMVA()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagCSVV2", nt.Jet_btagCSVV2()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagDeepB", nt.Jet_btagDeepB()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagDeepC", nt.Jet_btagDeepC()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagDeepFlavB", nt.Jet_btagDeepFlavB()[i]);
        ana.tx.pushbackToBranch<float>("Jet_btagDeepFlavC", nt.Jet_btagDeepFlavC()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chEmEF", nt.Jet_chEmEF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chFPV0EF", nt.Jet_chFPV0EF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chFPV1EF", nt.Jet_chFPV1EF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chFPV2EF", nt.Jet_chFPV2EF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chFPV3EF", nt.Jet_chFPV3EF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_chHEF", nt.Jet_chHEF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_eta", nt.Jet_eta()[i]);
        ana.tx.pushbackToBranch<float>("Jet_mass", nt.Jet_mass()[i]);
        ana.tx.pushbackToBranch<float>("Jet_muEF", nt.Jet_muEF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_muonSubtrFactor", nt.Jet_muonSubtrFactor()[i]);
        ana.tx.pushbackToBranch<float>("Jet_neEmEF", nt.Jet_neEmEF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_neHEF", nt.Jet_neHEF()[i]);
        ana.tx.pushbackToBranch<float>("Jet_phi", nt.Jet_phi()[i]);
        ana.tx.pushbackToBranch<float>("Jet_pt", nt.Jet_pt()[i]);
        ana.tx.pushbackToBranch<float>("Jet_puIdDisc", nt.Jet_puIdDisc()[i]);
        ana.tx.pushbackToBranch<float>("Jet_qgl", nt.Jet_qgl()[i]);
        ana.tx.pushbackToBranch<float>("Jet_rawFactor", nt.Jet_rawFactor()[i]);
        ana.tx.pushbackToBranch<float>("Jet_bRegCorr", nt.Jet_bRegCorr()[i]);
        ana.tx.pushbackToBranch<float>("Jet_bRegRes", nt.Jet_bRegRes()[i]);
        ana.tx.pushbackToBranch<float>("Jet_cRegCorr", nt.Jet_cRegCorr()[i]);
        ana.tx.pushbackToBranch<float>("Jet_cRegRes", nt.Jet_cRegRes()[i]);
        ana.tx.pushbackToBranch<int>("Jet_electronIdx1", nt.Jet_electronIdx1()[i]);
        ana.tx.pushbackToBranch<int>("Jet_electronIdx2", nt.Jet_electronIdx2()[i]);
        ana.tx.pushbackToBranch<int>("Jet_jetId", nt.Jet_jetId()[i]);
        ana.tx.pushbackToBranch<int>("Jet_muonIdx1", nt.Jet_muonIdx1()[i]);
        ana.tx.pushbackToBranch<int>("Jet_muonIdx2", nt.Jet_muonIdx2()[i]);
        ana.tx.pushbackToBranch<int>("Jet_nConstituents", nt.Jet_nConstituents()[i]);
        ana.tx.pushbackToBranch<int>("Jet_nElectrons", nt.Jet_nElectrons()[i]);
        ana.tx.pushbackToBranch<int>("Jet_nMuons", nt.Jet_nMuons()[i]);
        ana.tx.pushbackToBranch<int>("Jet_puId", nt.Jet_puId()[i]);
        ana.tx.pushbackToBranch<int>("Jet_genJetIdx", nt.Jet_genJetIdx()[i]);
        ana.tx.pushbackToBranch<int>("Jet_hadronFlavour", nt.Jet_hadronFlavour()[i]);
        ana.tx.pushbackToBranch<int>("Jet_partonFlavour", nt.Jet_partonFlavour()[i]);
        ana.tx.pushbackToBranch<int>("Jet_cleanmask", nt.Jet_cleanmask()[i]);
    }

    // GenJet
    for (unsigned int i = 0; i < (nt.GenJet_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("GenJet_eta", nt.GenJet_eta()[i]);
        ana.tx.pushbackToBranch<float>("GenJet_mass", nt.GenJet_mass()[i]);
        ana.tx.pushbackToBranch<float>("GenJet_phi", nt.GenJet_phi()[i]);
        ana.tx.pushbackToBranch<float>("GenJet_pt", nt.GenJet_pt()[i]);
        ana.tx.pushbackToBranch<int>("GenJet_partonFlavour", nt.GenJet_partonFlavour()[i]);
        ana.tx.pushbackToBranch<int>("GenJet_hadronFlavour", nt.GenJet_hadronFlavour()[i]);
    }

    // SubJet
    for (unsigned int i = 0; i < (nt.SubJet_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("SubJet_btagCMVA", nt.SubJet_btagCMVA()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_btagCSVV2", nt.SubJet_btagCSVV2()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_btagDeepB", nt.SubJet_btagDeepB()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_eta", nt.SubJet_eta()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_mass", nt.SubJet_mass()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_n2b1", nt.SubJet_n2b1()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_n3b1", nt.SubJet_n3b1()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_phi", nt.SubJet_phi()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_pt", nt.SubJet_pt()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_rawFactor", nt.SubJet_rawFactor()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_tau1", nt.SubJet_tau1()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_tau2", nt.SubJet_tau2()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_tau3", nt.SubJet_tau3()[i]);
        ana.tx.pushbackToBranch<float>("SubJet_tau4", nt.SubJet_tau4()[i]);
        ana.tx.pushbackToBranch<int>("SubJet_nBHadrons", nt.SubJet_nBHadrons()[i]);
        ana.tx.pushbackToBranch<int>("SubJet_nCHadrons", nt.SubJet_nCHadrons()[i]);
    }

    // GenJetAK8
    for (unsigned int i = 0; i < (nt.GenJetAK8_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("GenJetAK8_eta", nt.GenJetAK8_eta()[i]);
        ana.tx.pushbackToBranch<float>("GenJetAK8_mass", nt.GenJetAK8_mass()[i]);
        ana.tx.pushbackToBranch<float>("GenJetAK8_phi", nt.GenJetAK8_phi()[i]);
        ana.tx.pushbackToBranch<float>("GenJetAK8_pt", nt.GenJetAK8_pt()[i]);
        ana.tx.pushbackToBranch<int>("GenJetAK8_partonFlavour", nt.GenJetAK8_partonFlavour()[i]);
        ana.tx.pushbackToBranch<int>("GenJetAK8_hadronFlavour", nt.GenJetAK8_hadronFlavour()[i]);
    }

    // SubGenJetAK8
    for (unsigned int i = 0; i < (nt.SubGenJetAK8_pt()).size(); ++i){
        ana.tx.pushbackToBranch<float>("SubGenJetAK8_eta", nt.SubGenJetAK8_eta()[i]);
        ana.tx.pushbackToBranch<float>("SubGenJetAK8_mass", nt.SubGenJetAK8_mass()[i]);
        ana.tx.pushbackToBranch<float>("SubGenJetAK8_phi", nt.SubGenJetAK8_phi()[i]);
        ana.tx.pushbackToBranch<float>("SubGenJetAK8_pt", nt.SubGenJetAK8_pt()[i]);
    }
...
int Process_1Lepton_GenMatching_LastCopy_FlagNotUsed(int PID){
    // use the same method miniAOD-framework used

    int LastCopyID = PID;
    int PGDID = nt.GenPart_pdgId()[PID];
    int PGDID_daughter = -99;
    vector<int> daughterindex = Process_1Lepton_GenMatching_daughterindex(PID);
    for (size_t id=0; id<daughterindex.size();id++){
        if(nt.GenPart_pdgId()[daughterindex[id]]==PGDID){
            LastCopyID = daughterindex[id];
            PGDID_daughter = nt.GenPart_pdgId()[daughterindex[id]];
        }
    }
    if(PGDID_daughter == PGDID){
        return Process_1Lepton_GenMatching_LastCopy_FlagNotUsed(LastCopyID);
    }
                            ...
                            if(NWkk_W_daughter==2){
                                if(abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==11 || abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==13 || abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==15 || abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==12 || abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==14 || abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[0]])==16){
                                    ...
                                    for (size_t iwkk_wd=0; iwkk_wd<2;iwkk_wd++){
                                        if(abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[iwkk_wd]])==11){
                                            ...
                                            ana.tx.setBranch<int>("status_1", 1);
                                        }
                                        if(abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[iwkk_wd]])==13){
                                            ...
                                            ana.tx.setBranch<int>("status_1", 2);
                                        }
                                        if(abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[iwkk_wd]])==15){
                                            ...
                                            ana.tx.setBranch<int>("status_1", 3);
                                ...
                                for (size_t iwkk_wd=0; iwkk_wd<2;iwkk_wd++){
                                    if(abs(nt.GenPart_pdgId()[Wkk_W_daughter_index[iwkk_wd]]) < 6){
                                        ...
                                        ana.tx.setBranch<int>("status_1", 4);
                                ...
                                {
                                    ana.tx.setBranch<int>("status_1", 5);
                                }
                            }
                        }
                    }
                        ...
                        if(nt.GenPart_pdgId()[Radion_daughter_index[ird]] == 24){
                            ...
                            if(NR_W_daughter==2){
                                if(abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==11 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==13 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==15 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==12 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==14 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==16){
                                    ...
                                    ana.tx.setBranch<int>("status_2", 0);
                                    for (size_t ir_wd=0; ir_wd<2;ir_wd++){
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==11){
                                            ...
                                            ana.tx.setBranch<int>("status_2", 1);
                                        }
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==13){
                                            ...
                                            ana.tx.setBranch<int>("status_2", 2);
                                        }
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==15){
                                            ...
                                            ana.tx.setBranch<int>("status_2", 3);
                                ...
                                for (size_t ir_wd=0; ir_wd<2;ir_wd++){
                                    if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]]) < 6){
                                        ...
                                        ana.tx.setBranch<int>("status_2", 4);
                                ...
                                {
                                    ana.tx.setBranch<int>("status_2", 5);
                                }
                            }
                        }
                        if(nt.GenPart_pdgId()[Radion_daughter_index[ird]] == -24){
                            ...
                            if(NR_W_daughter==2){
                                if(abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==11 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==13 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==15 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==12 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==14 || abs(nt.GenPart_pdgId()[R_W_daughter_index[0]])==16){
                                    ...
                                    ana.tx.setBranch<int>("status_3", 0);
                                    for (size_t ir_wd=0; ir_wd<2;ir_wd++){
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==11){
                                            ...
                                            ana.tx.setBranch<int>("status_3", 1);
                                        }
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==13){
                                            ...
                                            ana.tx.setBranch<int>("status_3", 2);
                                        }
                                        if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]])==15){
                                            ...
                                            ana.tx.setBranch<int>("status_3", 3);
                                            int LastCopyW_tauid = Process_1Lepton_GenMatching_LastCopy(R_W_daughter_index[ir_wd]);
                                            vector<int> R_W_tau_daughter_index;
                                            R_W_tau_daughter_index = Process_1Lepton_GenMatching_daughterindex(LastCopyW_tauid);
                                            int NR_W_tau_daughter = R_W_tau_daughter_index.size();
                                ...
                                for (size_t ir_wd=0; ir_wd<2;ir_wd++){
                                    if(abs(nt.GenPart_pdgId()[R_W_daughter_index[ir_wd]]) < 6){
                                        ...
                                        ana.tx.setBranch<int>("status_3", 4);
                                ...
                                if(abs(nt.GenPart_pdgId()[R_W_daughter_index[0]]) == 24)
                                {
                                    ana.tx.setBranch<int>("status_3", 5);
                                }
                            }
                        }
                    }
...
void Process_1Lepton_GenMatching_g_FlagNotUsed(){
    for(size_t ik=0; ik<nt.nGenPart();ik++){
        if (abs(nt.GenPart_pdgId()[ik]) == 21 )
            {
                int lastcopyid = Process_1Lepton_GenMatching_LastCopy_FlagNotUsed(ik);

                //  check overlap here
                bool overlap = false;

                for(unsigned int inum = 0; inum < ana.tx.getBranchLazy<vector<float>>("ptgengl_FlagNotUsed").size(); ++inum){
                    if(abs(nt.GenPart_pt()[lastcopyid] - ana.tx.getBranchLazy<vector<float>>("ptgengl_FlagNotUsed")[inum])<(0.001*nt.GenPart_pt()[lastcopyid])){
                        overlap = true;
                    }
                }
                if(overlap) continue;
                ...
                if( nt.GenPart_pt()[ik] > 50 ){
                    ana.tx.pushbackToBranch<float>("ptgengl_FlagNotUsed", nt.GenPart_pt()[lastcopyid]);
                    ana.tx.pushbackToBranch<float>("etagengl_FlagNotUsed", nt.GenPart_eta()[lastcopyid]);
                    ana.tx.pushbackToBranch<float>("phigengl_FlagNotUsed", nt.GenPart_phi()[lastcopyid]);
                    ana.tx.pushbackToBranch<float>("massgengl_FlagNotUsed", nt.GenPart_p4()[lastcopyid].mass());

                    int FirstCopy = Process_1Lepton_GenMatching_FirstCopy(lastcopyid);
                    ana.tx.pushbackToBranch<float>("ptgengf_FlagNotUsed", nt.GenPart_pt()[FirstCopy]);
                    ana.tx.pushbackToBranch<float>("etagengf_FlagNotUsed", nt.GenPart_eta()[FirstCopy]);
                    ana.tx.pushbackToBranch<float>("phigengf_FlagNotUsed", nt.GenPart_phi()[FirstCopy]);
                    ana.tx.pushbackToBranch<float>("massgengf_FlagNotUsed", nt.GenPart_p4()[FirstCopy].mass());
                    // miniAOD find mother in a more complex way
                    // cout<<"mothergengf id:"<<nt.GenPart_genPartIdxMother()[FirstCopy]<<endl;// debug
                    // cout<<"first copy id:"<<FirstCopy<<endl;// debug
                    if(nt.GenPart_genPartIdxMother()[FirstCopy]>0){
                        ana.tx.pushbackToBranch<int>("mothergengf_FlagNotUsed", nt.GenPart_pdgId()[nt.GenPart_genPartIdxMother()[FirstCopy]]);
                    }
                }
            }
    }
...
void Process_1Lepton_GenMatching(){
    if(not nt.isData()){//MC Info
        ...
        Process_1Lepton_GenMatching_g_FlagNotUsed();
...
void Process_1Lepton_fatJets(){
    ...
    if (usenumber3>-1) {
        ...
        ana.tx.setBranch<float>("jetAK8puppi_sd_NoJEC", Process_1Lepton_Fatjet_SoftdropMass_NoJEC(usenumber3));
    ...
    if (usenumber2>-1) {
        ...
        ana.tx.setBranch<float>("jetAK8puppi_sd_NoJEC_2", Process_1Lepton_Fatjet_SoftdropMass_NoJEC(usenumber2));
    ...
    if (usenumber1>-1) {
        ...
        ana.tx.setBranch<float>("jetAK8puppi_sd_NoJEC_3", Process_1Lepton_Fatjet_SoftdropMass_NoJEC(usenumber1));
...
void Process_1Lepton__Weight_HLT(){
    // for L1 prefiring 
    
    // for some samples, this branch may not exist
    // ana.tx.setBranch<float>("Lepton1_L1PreFiringWeight_Nom", nt.L1PreFiringWeight_Nom());
    try { ana.tx.setBranch<float>        ("Lepton1_L1PreFiringWeight_Nom", nt.L1PreFiringWeight_Nom()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_L1PreFiringWeight_Nom", -99); }

    // pile-up reweight
    if ( not nt.isData()){
    ana.tx.setBranch<float>("Lepton1_Pileup_nTrueInt", nt.Pileup_nTrueInt());
    ana.tx.setBranch<int>("Lepton1_Pileup_nPU", nt.Pileup_nPU());
    ana.tx.setBranch<int>("Lepton1_Pileup_gpudensity", nt.Pileup_gpudensity() );
    }

    // HLT
    // Do I stored all the HLT that we needed ?
    try { ana.tx.setBranch<int>("Lepton1_HLT_Mu50", nt.HLT_Mu50() ); }                catch (std::runtime_error) { ana.tx.setBranch<int>("Lepton1_HLT_Mu50", -99 ); }
    try { ana.tx.setBranch<int>("Lepton1_HLT_IsoMu24", nt.HLT_IsoMu24() ); }                catch (std::runtime_error) { ana.tx.setBranch<int>("Lepton1_HLT_IsoMu24", -99 ); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_OldMu100", nt.HLT_OldMu100()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_OldMu100", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_TkMu100", nt.HLT_TkMu100()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_TkMu100", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_IsoMu27", nt.HLT_IsoMu27()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_IsoMu27", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele27", nt.HLT_Ele27_WPTight_Gsf()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele27", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele35_WPTight_Gsf", nt.HLT_Ele35_WPTight_Gsf()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele35_WPTight_Gsf", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_Photon200", nt.HLT_Photon200()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_Photon200", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele32_WPTight_Gsf_L1DoubleEG", nt.HLT_Ele32_WPTight_Gsf_L1DoubleEG()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele32_WPTight_Gsf_L1DoubleEG", -99); }
    try { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele32_WPTight_Gsf", nt.HLT_Ele32_WPTight_Gsf()); }                catch (std::runtime_error) { ana.tx.setBranch<int>        ("Lepton1_HLT_Ele32_WPTight_Gsf", -99); }

    // vertex
    // one good primary vertex requirement has not been implemented yet, need to apply this in the transfer tree code
    ana.tx.setBranch<int>("Lepton1_PV_npvsGood", nt.PV_npvsGood() );
    // vertex need for pile up reweighting
...
void Process_1Lepton_FillBranch(){
    ...
    Proces_1Lepton_NanoAODBranch_NoPrefix();
    Process_1Lepton_GenMatching();
    Process_1Lepton_fatJets();
    Process_1Lepton_Jets();
    Process_1Lepton_leptonicW();
    Process_1Lepton__Weight_HLT();
}
...
void Process_1Lepton_Selection(){
    if (ana.tx.getBranchLazy<vector<int>>("Common_lep_idxs").size() == 1 && ana.tx.getBranchLazy<vector<int>>("Common_fatjet_idxs").size() > 0){
        ana.tx.setBranch<int>("Lepton1_Preselection", 1);
    }
    else{
        ana.tx.setBranch<int>("Lepton1_Preselection", 0);
    }


    // if (true){      // to remove
    if (ana.tx.getBranchLazy<int>("Lepton1_Preselection") == 1){
